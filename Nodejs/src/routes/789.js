...
const LOGIN_MESSAGE = [
  ...
  {
    "info": "{\"ipAddress\":\"2401:d800:5540:856c:ed4c:46d9:8c6d:9603\",\"wsToken\":\"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..3DE78H-kw1Jclr5DA5Z_9syZJouB2x-6ccCJP5bZk8U\",\"locale\":\"vi\",\"userId\":\"0ef96a5e-8560-4c83-8d5f-7bd641cf3474\",\"username\":\"S8_nhaydz\",\"timestamp\":1765505701235,\"refreshToken\":\"e0de636450a74e83bdca0028a6bac7e3.5dad1e3f6824478b82a08a26f72172f1\"}",
    "signature": ""
  }
];
...
async function autoPrediction() {
  try {
    ...
    if (lastProcessedPhien.b52 !== nextPhien) {
      await verifyPredictions('b52', gameData);
      ...
      console.log(`[789-Auto] Phien ${nextPhien}: ${result.prediction} (${result.confidence}%)`);
    }
  } catch (error) {
    console.error('[789-Auto] Error:', error.message);
  }
}

function startAutoPrediction() {
  setInterval(autoPrediction, AUTO_PREDICT_INTERVAL);
  console.log('[789] Auto-prediction started (every 3s)');
}
...
function calculateAdvancedPrediction(data, type) {
  ...
  const aiResult = generateAIPrediction('789', last50);
...
router.get('/taixiu/lsdudoan', (req, res) => {
  const predictions = learningData.b52?.predictions || [];
  ...
  res.json({
    id: 'API BY BO NHAY DZ',
    type: '789 Tài Xỉu - Lịch sử dự đoán',
